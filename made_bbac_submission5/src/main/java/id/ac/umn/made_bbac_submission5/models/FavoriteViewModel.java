package id.ac.umn.made_bbac_submission5.models;
...
import id.ac.umn.made_bbac_submission5.pojos.Movie;
import id.ac.umn.made_bbac_submission5.pojos.Tv;

import java.util.ArrayList;
import java.util.List;

import static id.ac.umn.made_bbac_submission5.databases.FavoritesHelper.CONTENT_URI;
...
public class FavoriteViewModel extends ViewModel {
    ...
    public void loadFavorite(View v, ImageView loadingImage, TextView loadingText, String data_type, String userName) {
        ...
        Uri uri = Uri.parse(CONTENT_URI + "/" + userName + "/" + data_type);
