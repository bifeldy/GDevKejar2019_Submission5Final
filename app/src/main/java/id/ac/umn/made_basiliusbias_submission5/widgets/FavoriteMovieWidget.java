...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "id.ac.umn.made_basiliusbias_submission5.TOAST_ACTION";
    static final String EXTRA_ITEM = "id.ac.umn.made_basiliusbias_submission5.EXTRA_ITEM";
